...
<div id="main">
  ...
  <div id="content" align="center">
     ...
     <div id="center">
      ...
      <FORM onSubmit="return checkGetPasswdForm(this);" action="passwd_missingAction.action" 
      method="post">
      <TABLE width="100%" align=center border=0>
        ...
        <TR>
          ...
          <TD align=left width="60%"><INPUT class=input1 name=userName value="${userName }"/> </TD></TR>
        <TR>
     ...
     if("${msg}".trim()=="ok"){
    	 alert("系统为您分配的新密码是${passwd},请及时更改.");
     }
     </script>
     <div class="clear"></div>
  </div>

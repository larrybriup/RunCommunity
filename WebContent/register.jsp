...
<script type="text/javascript">
	function changeImage(img){
		img.src="AuthImg?"+new Date().getTime();
	}
	function checkCode(code){
		var n=session.getAttribute("authCode");
		alert(n);
     ...
     <div id="center">
       ...
       <div id="ltd">
	     ...
	     <TABLE cellSpacing=0 cellPadding=0 border=0>
	  			<TR>
    				<TD width="100%">
     					<FORM onSubmit="return validateRegisterForm(this);" action="MemberRegisterAction.action" method="post">
     						<TABLE width="100%">
        						<thead>
        						<TR>
         							<TH colSpan=3>
								...
								<TR>
								  ...
								  <TD><INPUT style="width:200px" name="authCode" value=" <%=session.getAttribute("authCode")%>" onblur="checkCode(this.value)"/> </TD>
								  <TH><IMG alt=authCode src="AuthImg" style="cursor:pointer;" title="点击更换" onclick="changeImage(this)"/> 
								</TH></TR>
								<tfoot>
								<TR>
								  <TD colSpan=3>

...
<div id="main">
  ...
  <div id="header">
    ...
    <div id="logo">
      <h1>跑步社区</h1></div>
	<div id="logout">
	<a href="LogoutAction.action">注 销</a>| 收  藏
	 </div>
    <div id="mainnav">
      <ul>
      ...
      <span><table width="100%" border="0">
								<tr>
									<td align="right">
										上一次登录时间：中国标准时间
											<s:date name="latestdate" format="yyyy年MM月dd日 hh:mm:ss E " />
									</td>
									<td align="center">
										欢迎,
										<a href="member/spaceAction.action"><font color="red">
									...
									<td align="left">
										...
										当前等级：
										<font color="red"><s:property value="#session.memberinfo.Graderecord.gradename"/></font>
									</td>
								</tr>
							</table> </span>    </div>
   </div>
...
到今天为止，盖茨和他的妻子Melinda Gates建立的基金已经将25多亿美元用于了全球的健康事业，将14亿多美元用于改善人们的学习条件，其中包括为盖茨图书馆购置计算机设备、为美国和加拿大的低收入社区的公共图书馆提供互联网培训和互联网访问服务             </p>
        ...
        <div id="hots">
          ...
          <li>
           <div>
            ...
            <a href="member/spaceAction.action">个性空间</a>
            <p>创建自己的个性空间</p>
           </div>
          </li>
          </ul>
	 ...
	 <table width="300">
      ...
      <h2> 积分排行榜</h2>
      <ul>
      	<s:iterator value="#session.members" id="m">
      		<li><a href="#"><s:property value="nickName"/></a></li>
      	</s:iterator>
      </ul>
     </div>
     <div class="clear"></div>

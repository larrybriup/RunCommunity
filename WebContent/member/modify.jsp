     ...
     <div id="center">
		...
		<table width="600">
			<thead>
  			...
  			<tr>
				<td width="100%">
					<form action="member/ModifyAction.action" method="post" onSubmit="return validateModifyForm(this);">
					...
					<tr>
						...
						<td width="30%" >
							<input type="text" maxLength="14" style="width:200px" name="nickName"  value='<s:property value="#session.memberinfo.nickName"/>' disabled />
						</td>
						<th width="45%" >
					...
					<tr>
						...
						<td>
							<input type="text" maxLength="30" style="width:200px" name="email" value='<s:property value="#session.memberinfo.email"/>'/>
						</td>
						<th>
					...
					<tr>
						...
						<th>
							<input style="width:200px" type="text" name="passwdQuestion" value='<s:property value="#session.memberinfo.passwdQuestion"/>'/>
						</th>
						<th>
					...
					<tr>
						...
						<td>
							<!-- 
							<input type="radio" value="0" name="gender" checked='<s:property value="#session.memberinfo.gender" />=0?true:false'/>男
							<input type="radio" value="1" name="gender" checked='<s:property value="#session.memberinfo.gender" />=1?true:false'/>女
							 -->
					...
					<tr>
						...
						<td >
							...
							<script type="text/javascript">
								//预选中省份
								document.getElementsByName("provinceCity")[0]
										[<s:property value="#session.memberinfo.provinceCity" />]
										.selected="selected";
								//预选中性别
								document.getElementsByName("gender")
									['<s:property value="#session.memberinfo.gender" />'=="男"?0:1]
									.checked="checked";
							</script>
							<!-- 
							 -->
					...
					<tr>
						...
						<td>
							<input type="text" style="width:200px" name="phone" value='<s:property value="#session.memberinfo.phone"/>'/>
						</td>
						<th>
					...
					<tr>
						...
						<td>
							<input type="text" style="width:200px" name="address" value='<s:property value="#session.memberinfo.address"/>'/>
						</td>
						<th>&nbsp;</th>
					</tr>
					<tfoot>
